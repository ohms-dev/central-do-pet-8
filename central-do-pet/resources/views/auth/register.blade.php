...
<body>
  ...
  <h1>Cadastro <img src="https://img.icons8.com/metro/26/000000/change-user-male.png"/></h1>
  <p class="lead">Cadastro geral de usuários</p>
...
@if (App\Models\User::all()->isNotEmpty())
    <form action="{{route('register')}}" method="post">
        {{ csrf_field() }}
        <div class="form-group">
        <label for="name">Nome:</label>
